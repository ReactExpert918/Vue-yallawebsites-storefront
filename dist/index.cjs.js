...
function useWindowResize() {
  var _useState = React.useState(getWidth()),
      _useState2 = _slicedToArray(_useState, 2),
      width = _useState2[0],
      setWidth = _useState2[1];

  var _useState3 = React.useState(getHeight()),
...
var ModalContainer = styled__default['default'].div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  position: fixed;\n  left: 0;\n  top: 0;\n  width: 100vw;\n  height: 100vh;\n  background-color: rgba(0, 0, 0, 0.5);\n  z-index: 456;\n\n  display: flex;\n  justify-content: flex-start;\n  align-items: flex-start;\n\n  transition-property: background-color, border;\n  transition-duration: 0.2s;\n  transition-timing-function: linear;\n  user-select: none;\n  transition: visibility 0.2s, opacity 0.2s linear;\n  \n  visibility: ", ";\n  opacity: ", ";\n  \n  @media (min-width: 768px) {\n    justify-content: center;\n    align-items: ", ";\n  }\n"])), function (props) {
...
var Exit = styled__default['default'](SvgExit)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  padding: 0;\n  margin: 0;\n  display: block;\n  cursor: pointer;\n  fill: ", ";\n"])), function (props) {
  return props.scheme === 'dark' ? 'white' : '#828282';
});
var ModalPanelTitle = styled__default['default'].div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  flex: 0 0 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  font-weight: bold;\n  font-size: 18px;\n  padding: 5px 5px 5px 15px;\n  /*padding: 15px 18px;*/\n"])));
var ModalPanelBody = styled__default['default'].div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  flex: 0 0 100%;\n  /*padding: 0 15px 15px 15px;*/\n"])));
var DMActionModal = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(ModalPanelContainer, {
    ref: panel,
    scheme: scheme,
    width: width,
    maxWidth: maxWidth
  }, /*#__PURE__*/React__default['default'].createElement(ModalPanelTitle, null, /*#__PURE__*/React__default['default'].createElement("div", null, title && title), /*#__PURE__*/React__default['default'].createElement(Exit, {
    scheme: scheme,
    onClick: handleClose
  })), /*#__PURE__*/React__default['default'].createElement(ModalPanelBody, null, children)));
});
/*
...
var ModalContainer$1 = styled__default['default'].div(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  background-color: rgba(0, 0, 0, 0.5);\n  z-index: 456;\n  display: flex;\n  flex-wrap: nowrap;\n  justify-content: flex-start;\n  align-items: flex-start;\n  transition-property: background-color, border;\n  transition-duration: 0.2s;\n  transition-timing-function: linear;\n  user-select: none;\n  transition: visibility 0.2s, opacity 0.2s linear;\n  visibility: ", ";\n  opacity: ", ";\n\n  @media (min-width: 768px) {\n    justify-content: center;\n    align-items: ", ";\n  }\n"])), function (props) {
  return props.show === true ? 'visible' : 'hidden';
}, function (props) {
  return props.show === true ? 1 : 0;
}, function (props) {
...
var ModalPanelContainer$1 = styled__default['default'].div(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  position: relative;\n  font-family: 'Helvetica Neue', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', sans-serif;\n  \n  background-color: ", ";\n  color: ", ";\n  border-radius: 0;\n  \n  display: flex;\n  flex-direction: column;\n  justify-content: stretch;\n  \n  width: 100%;\n  max-height: 100%;\n\n  overflow-y: auto;\n  \n  @media (min-width: 768px) {\n    border-radius: 10px;\n    width: ", ";\n    max-width: ", ";\n  }\n"])), function (props) {
  return props.scheme === 'dark' ? '#333' : 'white';
}, function (props) {
  return props.scheme === 'dark' ? 'white' : 'black';
}, function (props) {
...
var ModalPanelCloseContainer = styled__default['default'].div(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 5px;\n  right: 5px;\n"])));
var Exit$1 = styled__default['default'](SvgExit)(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["\n  padding: 0;\n  margin: 0;\n  margin: 0 auto;\n  display: block;\n  cursor: pointer;\n  fill: ", ";\n"])), function (props) {
  return props.scheme === 'dark' ? 'white' : '#828282';
});
var ModalPanelTitle$1 = styled__default['default'].div(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: nowrap;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  align-self: center;\n  font-weight: bold;\n  font-size: 18px;\n  padding: 5px 0 20px 5px;\n  /*padding: 15px 18px;*/\n"])));
var ModalPanelBody$1 = styled__default['default'].div(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  padding: 0 20px 20px 20px;\n  display: flex;\n  flex-wrap: nowrap;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  align-self: center;\n"])));
var DMSimpleModal = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var onClose = _ref.onClose,
      overlayClose = _ref.overlayClose,
      children = _ref.children,
      title = _ref.title,
  ...
  return /*#__PURE__*/React__default['default'].createElement(ModalContainer$1, {
    ref: overlay,
    isMinimized: isMinimized,
    show: isVisible,
    onClick: handleOverlay
  }, /*#__PURE__*/React__default['default'].createElement(ModalPanelContainer$1, {
    ref: panel,
    scheme: scheme,
    width: width,
    maxWidth: maxWidth
  }, /*#__PURE__*/React__default['default'].createElement(ModalPanelCloseContainer, null, /*#__PURE__*/React__default['default'].createElement(Exit$1, {
    scheme: scheme,
    onClick: handleClose
  })), /*#__PURE__*/React__default['default'].createElement(ModalPanelTitle$1, null, title && title), /*#__PURE__*/React__default['default'].createElement(ModalPanelBody$1, null, children)));
});
...
var ModalContainer$2 = styled__default['default'].div(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  background-color: transparent;\n  z-index: 456;\n  display: flex;\n  flex-wrap: nowrap;\n  justify-content: flex-start;\n  align-items: flex-start;\n  transition-property: background-color, border;\n  transition-duration: 0.2s;\n  transition-timing-function: linear;\n  user-select: none;\n  transition: visibility 0.2s, opacity 0.2s linear;\n  visibility: ", ";\n  opacity: ", ";\n\n  @media (min-width: 768px) {\n    /*justify-content: center;\n    align-items: center;*/\n  }\n"])), function (props) {
  return props.show === true ? 'visible' : 'hidden';
}, function (props) {
  return props.show === true ? 1 : 0;
});
var ModalPanelContainer$2 = styled__default['default'].div(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["\n  font-family: 'Helvetica Neue', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', sans-serif;\n  position: absolute;\n  background-color: ", ";\n  color: ", ";\n  /*padding: 20px;*/\n  display: flex;\n  flex-wrap: nowrap;\n  flex-direction: column;\n  justify-content: stretch;\n  border-radius: 0;\n  width: 100%;\n  overflow: hidden;\n  @media (min-width: 768px) {\n    border-radius: 5px;\n    width: ", ";\n    max-width: ", ";\n    ", ";\n    ", ";\n    ", ";\n    ", ";\n  }\n"])), function (props) {
  return props.scheme === 'dark' ? '#333' : 'white';
}, function (props) {
  return props.scheme === 'dark' ? 'white' : 'black';
}, function (props) {
...
var ModalPanelCloseContainer$1 = styled__default['default'].div(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 5px;\n  right: 5px;\n"])));
var Exit$2 = styled__default['default'](SvgMinus)(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral(["\n  padding: 0;\n  margin: 0;\n  margin: 0 auto;\n  display: block;\n  cursor: pointer;\n  fill: ", ";\n"])), function (props) {
  return props.scheme === 'dark' ? 'white' : '#828282';
});
var ModalPanelTitle$2 = styled__default['default'].div(_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: stretch;\n  align-items: center;\n  font-weight: bold;\n  font-size: 13px;\n  height: 36px;\n  background-color: ", ";\n  color: ", ";\n"])), function (props) {
  return props.scheme === 'dark' ? '#464646' : '#C6C6C6';
}, function (props) {
  return props.scheme === 'dark' ? 'white' : 'black';
});
var Title = styled__default['default'].div(_templateObject6$1 || (_templateObject6$1 = _taggedTemplateLiteral(["\n  width: 100%;\n  text-align: center;\n"])));
var ModalPanelBody$2 = styled__default['default'].div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  padding: 13px 20px 20px 20px;\n  display: flex;\n  flex-wrap: nowrap;\n  flex-direction: column;\n  justify-content: flex-start;\n  background-color: ", ";\n  font-size: 13px;\n"])), function (props) {
  return props.scheme === 'dark' ? 'back' : 'white';
});
var DMToolTipModal = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var onClose = _ref.onClose,
      overlayClose = _ref.overlayClose,
      children = _ref.children,
      title = _ref.title,
  ...
  return /*#__PURE__*/React__default['default'].createElement(ModalContainer$2, {
    ref: overlay,
    show: isVisible,
    onClick: handleOverlay
  }, /*#__PURE__*/React__default['default'].createElement(ModalPanelContainer$2, _extends({
    scheme: scheme,
    width: width,
    maxWidth: maxWidth
  }, props), /*#__PURE__*/React__default['default'].createElement(ModalPanelCloseContainer$1, null, /*#__PURE__*/React__default['default'].createElement(Exit$2, {
    scheme: scheme,
    onClick: handleClose
  })), /*#__PURE__*/React__default['default'].createElement(ModalPanelTitle$2, {
    scheme: scheme
  }, /*#__PURE__*/React__default['default'].createElement(Title, null, title && title)), /*#__PURE__*/React__default['default'].createElement(ModalPanelBody$2, {
    scheme: scheme
  }, children)));
});
...
var ModalPanelContainer$3 = styled__default['default'].div(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  position: fixed;\n  top: 0;\n  left: 0;\n  visibility: ", ";\n  background-color: ", ";\n  color: ", ";\n\n  z-index: 9;\n  font-family: 'Helvetica Neue', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', sans-serif;\n  border-radius: 0;\n  display: flex;\n  flex-direction: column;\n  justify-content: stretch;\n  width: 100%;\n  max-height: 100%;\n  overflow-y: auto;\n\n  @media (min-width: 768px) {\n    border-radius: 10px;\n    width: auto;\n    position: absolute;\n    top: ", ";\n    left: ", ";\n  }\n"])), function (props) {
  return props.show === true ? 'visible' : 'hidden';
}, function (props) {
  return props.scheme === 'dark' ? '#333' : 'white';
}, function (props) {
...
var ModalPanelCloseContainer$2 = styled__default['default'].div(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 5px;\n  right: 5px;\n"])));
var Exit$3 = styled__default['default'](SvgExit)(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral(["\n  padding: 0;\n  margin: 0;\n  margin: 0 auto;\n  display: block;\n  cursor: pointer;\n  fill: ", ";\n"])), function (props) {
  return props.scheme === 'dark' ? 'white' : '#828282';
});
var ModalPanelTitle$3 = styled__default['default'].div(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral(["\n  display: flex;\n  flex-wrap: nowrap;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  align-self: center;\n  font-weight: bold;\n  font-size: 24px;\n  padding: 5px 0 20px 5px;\n"])));
var ModalPanelBody$3 = styled__default['default'].div(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral(["\n  padding: 0 50px;\n  display: flex;\n  flex-wrap: nowrap;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  align-self: center;\n"])));
var ShareContainer = styled__default['default'].div(_templateObject6$2 || (_templateObject6$2 = _taggedTemplateLiteral(["\n  padding: 40px 15px;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  gap: 10px;\n  white-space: nowrap;\n  font-weight: 500;\n  color: #333;\n  @media (min-width: 768px) {\n    padding: 40px 20px;\n  }\n"])));
var CopyLink = styled__default['default'](SvgCopylink)(_templateObject7$1 || (_templateObject7$1 = _taggedTemplateLiteral(["\n  fill: #ff5e6d;\n  width: 30px;\n"])));
var Circle = styled__default['default'].div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  border-radius: 50%;\n  height: 60px;\n  width: 60px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  align-self: center;\n\n  box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.15);\n\n  &:hover {\n    box-shadow: 0px 1px 20px rgba(0, 0, 0, 0.15);\n  }\n"])));
var DMShareModal = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var onClose = _ref.onClose,
      scheme = _ref.scheme;
  ...
  var _useState3 = React.useState('https://www.decormatters.com'),
      _useState4 = _slicedToArray(_useState3, 2),
      shareUrl = _useState4[0],
      setShareUrl = _useState4[1];

  var _useState5 = React.useState('https://www.decormatters.com'),
      _useState6 = _slicedToArray(_useState5, 2),
      imgUrl = _useState6[0],
      setImgUrl = _useState6[1];

  var _useState7 = React.useState('DecorMatters'),
  ...
  return /*#__PURE__*/React__default['default'].createElement(ModalPanelContainer$3, {
    ref: rContainer,
    scheme: scheme,
    left: posX + 'px',
    top: posY + 'px',
    show: isVisible
  }, /*#__PURE__*/React__default['default'].createElement(ModalPanelCloseContainer$2, null, /*#__PURE__*/React__default['default'].createElement(Exit$3, {
    scheme: scheme,
    onClick: handleClose
  })), /*#__PURE__*/React__default['default'].createElement(ModalPanelTitle$3, null, "Share This Design"), /*#__PURE__*/React__default['default'].createElement(ModalPanelBody$3, null, /*#__PURE__*/React__default['default'].createElement(ShareContainer, null, /*#__PURE__*/React__default['default'].createElement(reactShare.PinterestShareButton, {
    url: shareUrl,
    media: imgUrl
  }, /*#__PURE__*/React__default['default'].createElement(Circle, null, /*#__PURE__*/React__default['default'].createElement(SvgPins, null))), "Pinterest"), /*#__PURE__*/React__default['default'].createElement(ShareContainer, null, /*#__PURE__*/React__default['default'].createElement(reactShare.TwitterShareButton, {
    url: shareUrl,
    title: quote
  }, /*#__PURE__*/React__default['default'].createElement(Circle, null, /*#__PURE__*/React__default['default'].createElement(SvgTwitter, null))), "Twitter"), /*#__PURE__*/React__default['default'].createElement(ShareContainer, null, /*#__PURE__*/React__default['default'].createElement(reactShare.FacebookShareButton, {
    url: shareUrl,
    quote: quote
  }, /*#__PURE__*/React__default['default'].createElement(Circle, null, /*#__PURE__*/React__default['default'].createElement(SvgFb, null))), "Facebook"), /*#__PURE__*/React__default['default'].createElement(ShareContainer, null, /*#__PURE__*/React__default['default'].createElement(Circle, {
    onClick: shareClick
  }, /*#__PURE__*/React__default['default'].createElement(CopyLink, null)), "Copy Link")));
});
...
var Overlay = styled__default['default'].div(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n  z-index: 100;\n\n  transition: opacity 0.3s ease-out;\n  opacity: ", ";\n  visibility: ", ";\n"])), function (props) {
  return props.animate === 'true' ? '1' : '0';
}, function (props) {
  return props.visibility === 'true' ? 'visible' : 'hidden';
});
var Container = styled__default['default'].div(_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteral(["\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  z-index: 101;\n  display: flex;\n  pointer-events: none;\n  \n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  \n  visibility: ", ";\n"])), function (props) {
  return props.visibility === 'true' ? 'visible' : 'hidden';
});
var ExitButton = styled__default['default'].button(_templateObject3$4 || (_templateObject3$4 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 5px;\n  right: 5px;\n  border: none;\n  margin: 0;\n  padding: 0;\n  background: none;\n  cursor: pointer;\n"])));
var Exit$4 = styled__default['default'](SvgExit)(_templateObject4$4 || (_templateObject4$4 = _taggedTemplateLiteral(["\n  fill: ", ";\n"])), function (props) {
  return props.scheme === 'dark' ? 'white' : '#828282';
}); //justify-content: flex-start;

var Panel = styled__default['default'].div(_templateObject5$4 || (_templateObject5$4 = _taggedTemplateLiteral(["\n  background-color: white;\n\n  position: relative;\n  pointer-events: auto;\n  overflow: hidden;\n\n  display: flex;\n  flex-direction: column;\n  \n  width: 95%;\n  max-width: ", "px;\n  \n  background-color: ", ";\n  color: ", ";\n\n  ", "\n\n  top: ", ";\n\n  transition-property: top, opacity;\n  transition-duration: 0.3s;\n  transition-timing-function: ease-out;\n\n  justify-content: center;\n  border-radius: ", "px;\n  ", "\n\n  ", "\n"])), function (props) {
...
var PanelTitle = styled__default['default'].div(_templateObject6$3 || (_templateObject6$3 = _taggedTemplateLiteral(["\n  flex: 0 0 35px;\n  height: 35px;\n  min-height: 35px;\n  display: flex;\n  \n  align-items: center;\n  font-weight: bold;\n\n  justify-content: ", ";\n  margin-left: ", "px;\n"])), function (props) {
  return props.left === 'true' ? "flex-start" : "center";
}, function (props) {
  return props.left === 'true' ? "12" : "0";
});
var PanelBody = styled__default['default'].div(_templateObject7$2 || (_templateObject7$2 = _taggedTemplateLiteral(["\n  flex: 1 1 auto;\n  overflow-x: hidden;\n  overflow-y: auto;\n"])));
...
var DMModal = function DMModal(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Overlay, {
  ...
  }, !noClose && /*#__PURE__*/React__default['default'].createElement(ExitButton, {
    onClick: handleClose,
    "aria-label": "Close Modal"
  }, /*#__PURE__*/React__default['default'].createElement(Exit$4, {
    scheme: scheme
  })), /*#__PURE__*/React__default['default'].createElement(PanelTitle, {
    left: titleLeft ? 'true' : 'false'
  }, title), /*#__PURE__*/React__default['default'].createElement(PanelBody, null, children))));
};
...
var Container$1 = styled__default['default'].div(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["\n  position: relative;\n  padding: 0;\n  margin: 0;\n  pointer-events: none;\n\n  font-family: 'Helvetica Neue', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', sans-serif;\n"])));
var CenterContainer = styled__default['default'].div(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral(["\n  position: relative;\n"])));
var Background = styled__default['default'].div(_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 148px;\n  height: 148px;\n  background-size: cover;\n  border-radius: 50%;\n  background-color: transparent;\n  border: 0px !important;\n  box-shadow: none;\n  user-select: none;\n  z-index: 2;\n"])));
var ExpContainer = styled__default['default'].div(_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 172px;\n  height: 172px;\n  z-index: 3;\n"])));
var PictureContainer = styled__default['default'].div(_templateObject5$5 || (_templateObject5$5 = _taggedTemplateLiteral(["\n  position: absolute;\n  top: 12px;\n  left: 12px;\n  padding: 0;\n  margin: 0;\n  border: none;\n  outline: 0;\n  z-index: 4;\n"])));
var Placeholder = styled__default['default'].div(_templateObject6$4 || (_templateObject6$4 = _taggedTemplateLiteral(["\n  width: 172px;\n  height: 172px;\n"])));
var Picture = styled__default['default'].div(_templateObject7$3 || (_templateObject7$3 = _taggedTemplateLiteral(["\n  width: 148px;\n  height: 148px;\n  background-size: cover;\n  border-radius: 50%;\n  background-color: #f5f5f5;\n  border: 0px !important;\n  box-shadow: none;\n  user-select: none;\n"])));
var LevelTag = styled__default['default'].div(_templateObject8$1 || (_templateObject8$1 = _taggedTemplateLiteral(["\n  position: absolute;\n  width: 60px;\n  height: 22px;\n  margin: 0;\n\n  bottom: 0;\n  right: 0;\n\n  border-radius: 20px;\n\n  display: flex;\n  justify-content: center;\n  align-items: center;\n\n  font-size: 12px;\n  font-weight: 700;\n\n  user-select: none;\n  white-space: nowrap;\n  overflow: hidden;\n\n  color: ", ";\n  background-color: ", ";\n"])), function (props) {
  return props.active === false ? '#f5f5f5' : 'white';
}, function (props) {
  return props.active === false ? '#f5f5f5' : '#EF6971';
});
var DMProfilePic = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var pic = _ref.pic,
      level = _ref.level,
  ...
  var rGlow = React.useRef();
  var rTimer = React.useRef();
  var rCurRev = React.useRef(0);
  var rRevolutions = React.useRef([]);
  ...
  var startRevolutions = React.useCallback(function () {
  ...
  var setExpToRevolutions = React.useCallback(function (start, end) {
    rCurRev.current = 0;
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Container$1, null, /*#__PURE__*/React__default['default'].createElement(CenterContainer, null, /*#__PURE__*/React__default['default'].createElement(reactLottiePlayer.Player, {
    ref: rGlow,
    src: animationData,
    style: {
      height: '400px',
  ...
  }), /*#__PURE__*/React__default['default'].createElement(Background, null), showLevelBar && /*#__PURE__*/React__default['default'].createElement(ExpContainer, null, /*#__PURE__*/React__default['default'].createElement(reactCircularProgressbar.CircularProgressbar, {
    styles: ExpStyle,
    strokeWidth: 4,
    circleRatio: 0.945,
    value: exp
  })), /*#__PURE__*/React__default['default'].createElement(PictureContainer, null, /*#__PURE__*/React__default['default'].createElement(Picture, {
    style: {
      backgroundImage: "url(".concat(pic, ")")
    }
  }), /*#__PURE__*/React__default['default'].createElement(LevelTag, {
    active: currentLevel === false ? false : true
  }, "Lv ", currentLevel || 0)), /*#__PURE__*/React__default['default'].createElement(Placeholder, null))), /*#__PURE__*/React__default['default'].createElement(GradientSVG, {
    startColor: "#FF8171",
    endColor: "#FF6A8E",
    idCSS: "grad-id",
    rotation: "90"
...
var DecorButton = styled__default['default'].button(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["\n  user-select: none;\n  text-decoration: none;\n  text-align: center;\n  padding: ", ";\n  border-radius: 24px;\n  font-weight: 700;\n  font-size: ", ";\n  white-space: nowrap;\n  cursor: pointer;\n  margin: 0;\n  font-family: 'Helvetica Neue', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', sans-serif;\n"])), function (props) {
  return props.size === 'sm' ? '7px 20px' : '8px 20px';
}, function (props) {
  return props.size === 'sm' ? '12px' : '14px';
});
var DecorDivButton = styled__default['default'].div(_templateObject2$6 || (_templateObject2$6 = _taggedTemplateLiteral(["\n  user-select: none;\n  text-decoration: none;\n  text-align: center;\n  padding: ", ";\n  border-radius: 24px;\n  font-weight: 700;\n  font-size: ", ";\n  white-space: nowrap;\n  cursor: pointer;\n  margin: 0;\n  font-family: 'Helvetica Neue', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', sans-serif;\n"])), function (props) {
  return props.size === 'sm' ? '7px 20px' : '8px 20px';
}, function (props) {
  return props.size === 'sm' ? '12px' : '14px';
});
var PrimeButton = styled__default['default'](DecorButton)(_templateObject3$6 || (_templateObject3$6 = _taggedTemplateLiteral(["\n  color: white;\n  background-color: #ff5e6d;\n  border: 2px solid #ff5e6d;\n\n  &:hover:enabled {\n    /*background-color: transparent;*/\n    /*color: #ff5e6d;*/\n    background: linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)),  #ff5e6d;\n    border: 2px solid #c84e59;\n  }\n\n  &:hover:disabled {\n    cursor: default;\n  }\n\n  &:focus:enabled {\n    outline: none;\n  }\n\n  &:disabled {\n    color: ", ";\n    background-color: ", ";\n    border: 2px solid ", ";\n  }\n"])), function (props) {
...
var PrimeAltButton = styled__default['default'](DecorButton)(_templateObject4$6 || (_templateObject4$6 = _taggedTemplateLiteral(["\n  background-color: transparent;\n  \n  color: ", ";\n  border: 2px solid ", ";\n\n  &:hover:enabled {\n    background-color: #ff5e6d;\n    color: white;\n    border: 2px solid #ff5e6d;\n  }\n\n  &:hover:disabled {\n    cursor: default;\n  }\n\n  &:focus:enabled {\n    outline: none;\n  }\n\n  &:disabled {\n    color: ", ";\n    background-color: ", ";\n    border: 2px solid ", ";\n  }\n"])), function (props) {
...
var PrimeAltDivButton = styled__default['default'](DecorDivButton)(_templateObject5$6 || (_templateObject5$6 = _taggedTemplateLiteral(["\n  color: #ff5e6d;\n  background-color: transparent;\n  border: 2px solid #ff5e6d;\n\n  &:hover {\n    background-color: #ff5e6d;\n    color: white;\n  }\n\n  &:focus {\n    outline: none;\n  }\n\n  &:disabled {\n    color: ", ";\n    background-color: ", ";\n    border: 2px solid ", ";\n  }\n"])), function (props) {
...
var DMPrimaryButton = function DMPrimaryButton(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(PrimeButton, props, props.children);
};
var DMPrimaryAltButton = function DMPrimaryAltButton(_ref2) {
  var props = _extends({}, _ref2);

  return /*#__PURE__*/React__default['default'].createElement(PrimeAltButton, props, props.children);
};
var DMPrimaryAltDivButton = function DMPrimaryAltDivButton(_ref3) {
  var props = _extends({}, _ref3);

  return /*#__PURE__*/React__default['default'].createElement(PrimeAltDivButton, props, props.children);
}; //------------------------------------------------------------------------
// Coin Balance
//------------------------------------------------------------------------

var CoinBalanceContainer = styled__default['default'].div(_templateObject6$5 || (_templateObject6$5 = _taggedTemplateLiteral(["\n  margin-right: 10px;\n  display: flex;\n  flex-wrap: nowrap;\n  flex-direction: row;\n  justify-content: flex-end;\n  align-items: center;\n  align-self: center;\n  font-weight: bold;\n  white-space: nowrap;\n  font-size: ", "px;\n  cursor: pointer;\n  font-family: 'Helvetica Neue', -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', sans-serif;\n"])), function (props) {
  return props.size === 'lg' ? '13' : '12';
});
var Balance = styled__default['default'].div(_templateObject7$4 || (_templateObject7$4 = _taggedTemplateLiteral(["\n  color: ", ";\n"])), function (props) {
  return props.scheme === 'dark' ? '#FFFFFF' : '#000000';
});
var CoinContainer = styled__default['default'].div(_templateObject8$2 || (_templateObject8$2 = _taggedTemplateLiteral(["\n  margin-left: 5px;\n  margin-right: 5px;\n"])));
var Coin = styled__default['default'](SvgCoin)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  padding: 0;\n  margin: 0;\n  margin: 0 auto;\n  display: block;\n  width: ", "px;\n  height: ", "px;\n"])), function (props) {
  return props.size === 'lg' ? '24' : '19';
}, function (props) {
  return props.size === 'lg' ? '24' : '19';
});
var Count = styled__default['default'].div(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n  background: transparent;\n  color: ", ";\n"])), function (props) {
  return props.scheme === 'dark' ? '#FFFFFF' : '#000000';
});
var DMCoinBalance = function DMCoinBalance(_ref4) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(CoinBalanceContainer, {
    size: size,
    onClick: onClick
  }, /*#__PURE__*/React__default['default'].createElement(Balance, _extends({
    scheme: scheme
  }, props), "Coin Balance:"), /*#__PURE__*/React__default['default'].createElement(CoinContainer, null, /*#__PURE__*/React__default['default'].createElement(Coin, {
    size: size
  })), /*#__PURE__*/React__default['default'].createElement(Count, _extends({
    scheme: scheme
  }, props), formatMoney(coins)));
};

exports.DMActionModal = DMActionModal;
exports.DMCoinBalance = DMCoinBalance;
exports.DMModal = DMModal;
exports.DMPrimaryAltButton = DMPrimaryAltButton;
exports.DMPrimaryAltDivButton = DMPrimaryAltDivButton;
exports.DMPrimaryButton = DMPrimaryButton;
exports.DMProfilePic = DMProfilePic;
exports.DMShareModal = DMShareModal;
exports.DMSimpleModal = DMSimpleModal;
exports.DMToolTipModal = DMToolTipModal;
