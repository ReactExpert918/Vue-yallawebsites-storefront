        ...
        <div class="col-sm-12">
            ...
            <b-card-group columns>
                <b-card :img-src="require('@/assets/images/small/img-3.jpg')" img-alt="Image" img-top>
                    ...
                    <b-card-text>This is a longer card with supporting text below as a natural
                        lead-in to additional content. This content is a little bit
                        longer.</b-card-text>
                </b-card>
                ...
                <b-card class="text-center">
                    ...
                    <b-card-text>This card has a regular title and short paragraphy of text below
                        it.</b-card-text>
                    <b-card-text class="small text-muted">Last updated 3 mins ago</b-card-text>
                </b-card>
                ...
                <b-card>
                    ...
                    <b-card-text>This is another card with title and supporting text below. This
