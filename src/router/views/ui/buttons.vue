                ...
                <div class="card-body">
                    ...
                    <div class="button-items">
                        <b-button variant="primary">
                            <i class="bx bx-smile font-size-16 align-middle mr-2"></i>
                            Primary
                        </b-button>
                        ...
                        <b-button variant="warning">
                            <i class="bx bx-error font-size-16 align-middle mr-2"></i>
                            Warning
                        </b-button>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <b-form-checkbox-group v-model="selectedCheck" :options="optionsCheck" name="buttons-1" buttons button-variant="primary"></b-form-checkbox-group>
                        </div>
                        <div class="col-xl-6">
                            <b-form-radio-group id="btn-radios-1" v-model="selected" :options="options" buttons name="radios-btn-default"></b-form-radio-group>
                        </div>
                    </div>
                </div>
            </div>
