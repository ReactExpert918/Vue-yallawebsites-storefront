...
export default { 
  ...
  watch: {
    selectedAll: function() {
      const selectedLength = this.blockData.filter(data => data.selected);
      return this.blockData.forEach( e => {
        if(this.selectedAll === true) { e.selected = true; }
        else if (selectedLength.length === this.blockData.length) {
          e.selected = false;
        }
      })
    }
...
<template>
  <Layout>
            ...
            <div class="row mb-2">
              <div class="col-sm-12">
                <div class="text-sm-right">
                  <a href="/content/blocks/add">
                    <b-button v-b-modal.modal-scrollable variant="primary">
                      <i class="mdi mdi-plus mr-1"></i> Add block
                    </b-button>
                  </a>
                </div>
              </div>
              ...
              <div class="table-responsive mb-0">
                  ...
                  >
                    ...
                    <template #cell(selected)="data">
                      ...
                      class="custom-checkbox custom-checkbox-primary mb-3"
                    ...
                    <template #cell(actions)="data">
                      <b-dropdown class="card-drop" variant="white" right toggle-class="p-0">
                        ...
                        <b-dropdown-item :href="'/content/blocks/edit/' + data.item.id">
                          <i class="fas fa-pencil-alt text-success mr-1"></i> Edit
                        </b-dropdown-item>

                        <b-dropdown-item v-b-modal.modal-delete-page @click="block = data.item">
    ...
    <b-modal id="modal-delete-page" centered title="Delete Block" title-class="font-18" hide-footer>
      <p>Are you sure? Pressing Delete will remove this block permenantly.</p>
      <div class="text-right">
        <b-button variant="danger" @click="deleteBlock()">Delete</b-button>
      </div>
    </b-modal>
    <!-- end row -->
  </Layout>
