...
const Container = styled.div`
  ...
  ${props => props.size === MODAL_SIZE_FULLSCREEN && 'justify-content: center;'}

  ${props =>
    props.size === MODAL_SIZE_CONTENT &&
    `flex-direction: column;
      justify-content: flex-end;
      align-items: center;`}

  ${props =>
    props.size === MODAL_SIZE_PERCENTAGE &&
    `flex-direction: column;
      justify-content: flex-end;
      align-items: center;`}
  ...
  @media only screen and (min-width: 1025px) {
    ...
    ${props =>
      props.size === MODAL_SIZE_FULLSCREEN &&
      `flex-direction: column;
        align-items: center;`}
  }
`
...
const Panel = styled.div`
  ...
  ${props => (props.rounded === 'true' ? 'border-radius: 10px 10px 0 0;' : 'border-radius: 0;')}
...
const DMModal = ({ show, scheme, size = MODAL_SIZE_CONTENT, title, children, percentage, maxWidth, notRounded, titleLeft, onClose, noClose, noOverlayClose, stayFloat }) => {
