      ...
      <div class="d-flex">
        ...
        <b-dropdown right variant="black" toggle-class="header-item">
          ...
          >
            ...
            ></i>
            {{ $t("navbar.dropdown.customer.list.logout") }}
          </a>
        </b-dropdown>
